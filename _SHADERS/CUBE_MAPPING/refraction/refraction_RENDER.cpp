          ...
          //   ofstream modelViewMatrix("modelViewMatrix.cpp");
             
          //   modelViewMatrix << "var         MV_ROW_1    =  "   << modelView[0] << ", "  << modelView[1] << ", "  << modelView[2] << ", \n";  
          //   modelViewMatrix << "var         MV_ROW_2    =  "   << modelView[4] << ", "  << modelView[5] << ", "  << modelView[6] << ", \n";
          //   modelViewMatrix << "var         MV_ROW_3    =  "   << modelView[8] << ", "  << modelView[9] << ", "  << modelView[10] << ", \n";
    ...
    glUniformMatrix4fv(UNIFORM_MODELVIEW_refraction,       1,0,  modelView);                                                                                                          
